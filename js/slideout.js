...
Slideout.prototype.open = function() {
  ...
  document.getElementsByClassName("toggle-button")[0].style.backgroundImage = "url("+(mainView.location === "index.php" ? "":"../")+"images/arrow.svg)";
    $(".slideout-menu").fadeIn(100);
  return this;
};
...
Slideout.prototype.close = function() {
  ...
  document.getElementsByClassName("toggle-button")[0].style.backgroundImage = "url("+(mainView.location === "index.php" ? "":"../")+"images/menu.svg)";
    setTimeout(function () {
